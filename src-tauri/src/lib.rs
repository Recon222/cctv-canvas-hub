...
//! Feature implementations are organized in the `features` module,
...
pub use bindings::export_ts_bindings; // used by the `gen_bindings` binary
...
pub fn run() {
    ...
    app_builder
        ...
        .setup(|app| {
            ...
            {
                let saved_shortcut =
                    features::preferences::commands::load_quick_pane_shortcut(app.handle());
                ...
                features::quick_pane::commands::register_quick_pane_shortcut(
                    app.handle(),
            ...
            if let Err(e) = features::quick_pane::commands::init_quick_pane(app.handle()) {
